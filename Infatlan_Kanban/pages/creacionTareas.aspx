<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="creacionTareas.aspx.cs" Inherits="Infatlan_Kanban.pages.creacionTareas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
                ...
                <div class="card-body">
                    <nav>
                        <div class="nav nav-pills " id="nav-tab" role="tablist">
                            ...
                            <a class="nav-item nav-link" runat="server" visible="true" id="nav_tarjetaModificar_tab" data-toggle="tab" href="#nav-modificarTarjeta" role="tab" aria-controls="nav-modificarTarjeta" aria-selected="false"><i class="mdi  mdi-pencil"></i> Tarjetas a Reasignar</a>
                    ...
                    <div class="tab-content tabcontent-border">
                        ...
                        <div class="tab-pane fade show active" id="nav-crear" role="tabpanel">
                            ...
                            <div class="row">
                                <div class="col-md-12">                               
                                    ...
                                    <div class="tab-content tabcontent-border" style="height: 535px">
                                        <!--PRIMER CONTENIDO-->
                                                    ...
                                                    <ContentTemplate>
                                                        ...
                                                        <div class="row p-t-20">
                                                            ...
                                                            <div class="col-6">
                                                                ...
                                                                <asp:DropDownList runat="server" ID="DdlTipoGestion" CssClass="select2 form-control custom-select" Style="width: 100%" AutoPostBack="true" Enabled="true"></asp:DropDownList>
                                                            </div>
                                                        </div>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                                ...
                                                <div class="col-lg-12">
                                                    ...
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                                                        <ContentTemplate>
                                                                ...
                                                                <div class="row col-12 mt-3">
                                                                    <div class="table-responsive">
                                                                        <asp:GridView ID="GvAdjunto" runat="server"
                                                                            ...
                                                                            AutoGenerateColumns="false" OnPageIndexChanging="GvAdjunto_PageIndexChanging"
                                                            ...
                                                            <div class="col-md-12" runat="server" id="divAlertaAdjunto" visible="false" style="text-align: center">
                                                                <p><b><code><label class="col-form-label" runat="server" id="LbDuplicadoAdjunto"></label></code></b></p>
                                                            </div>
                                                    ...
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel2">
                                                        <ContentTemplate>
                                                            ...
                                                            <div class="col-md-12" runat="server" id="divAlertaComentario" visible="false" style="text-align: center">
                                                                <p><b><code>Tarea no cuenta con comentarios.</code></b></p>
                                                            </div>
                                                            ...
                                                            <div class="row col-12" runat="server" id="divComentariosTexbox">
                                                                ...
                                                                <div class="col-7">
                                                                    <asp:TextBox ID="TxComentario" TextMode="MultiLine" Rows="1" AutoPostBack="true" runat="server" class="form-control text-uppercase"></asp:TextBox>
                                                                </div>
                                                                <div class="col-4">
                                                            ...
                                                            <div class="col-md-12" runat="server" id="divAlertaComentarioVacio" visible="false" style="text-align: center">
                                                                <p><b><code>Campo de comentario vacío.</code></b></p>
                                                            </div>
                                                                    ...
                                                                    <div class="table-responsive">
                                                                        <asp:GridView ID="GvComentarioLectura" runat="server"
                                                                            ...
                                                                            <Columns>
                                                                                ...
                                                                                <asp:BoundField DataField="usuarioComentario" Visible="true" HeaderText="Usuario"   ItemStyle-Width="20%"/>
                                                                                <asp:BoundField DataField="comentario" HeaderText="Comentario" Visible="true" ItemStyle-Width="95%" />
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-11">
                                                                        <asp:DropDownList ID="DdlAccion" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="DdlAccion_SelectedIndexChanged">
                                                                            ...
                                                                            <asp:ListItem Value="1" Text="Solicitud Re-asignación de Tarjeta"></asp:ListItem>
                                                                            <asp:ListItem Value="2" Text="Cerrar Tarjeta Kanban"></asp:ListItem>
                                                                            <asp:ListItem Value="3" Text="Solicitud de Tarjeta a Estado Detenido"></asp:ListItem>
                                                                        </asp:DropDownList>
                                                                    </div>
                                                                </div>
                                                            </div>
                        ...
                        <div class="tab-pane" id="nav-modificarTarjeta" role="tabpanel" style="height: 720px">
                            ...
                            <div class="row p-t-20 col-9">
                                ...
                                <div class="col-8">
                                    <asp:TextBox runat="server" ID="TxBuscarReasignar" CssClass="form-control" placeholder="Búsqueda por Id Tarea o Nombre del colaborador.." OnTextChanged="TxBuscarReasignar_TextChanged"></asp:TextBox>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="nav-DetenidoTarjeta" role="tabpanel" style="height: 720px">
                            ...
                            <h6 class="card-subtitle">Datos generales de la tarjeta a detener.<code>( Lista de tareas a detener)</code>.</h6>
                            <br />
    ...
    <div class="modal fade" id="ModalConfirmarMaximaPrioridad" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="width: 800px; top: 450px; left: 50%; transform: translate(-50%, -50%);">
                ...
                <div class="modal-footer">
                    <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            ...
                            <asp:Button ID="BtnConfirmarTarea" runat="server" Text="Enviar" class="btn" style="background-color:#D9272E;  color: #ffffff;"  OnClick="BtnConfirmarTarea_Click" />
                        </ContentTemplate>
    ...
    <%--    MODAL INICIO--%>
    <div class="modal fade" id="ModalTarjeta" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="width: 800px; top: 450px; left: 50%; transform: translate(-50%, -50%);">
                <div class="modal-header">
                ...
                <div class="modal-footer">
                    <asp:UpdatePanel ID="UpdatePanel12" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                            <asp:Button ID="Button2" runat="server" Text="Enviar" class="btn" Style="background-color: #D9272E; color: #ffffff;" />
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </div>
            </div>
