...
namespace Infatlan_Kanban_GestionesTecnicas.pages
{
    public partial class creacionTareas : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["USUARIO_AD"] = "acamador";
            Session["GESTIONES_TEAMS_USER_LOGEADO"] = "14";
 ...
 String vEx = Request.QueryString["ex"];
            ...
            if (!Page.IsPostBack)
            {
                ...
                else if (vEx != null && vTarjetaCerrada == null && vTarjetaReasignar == null)
                {
                ...
                else if (vEx != null && vTarjetaReasignar != null && vTarjetaCerrada == null)
                {
        ...
        void cargarReasignarSolicitudes()
        {
            try
            {
                ...
                String vQuery = "GESTIONES_Solicitud 20,'" + Session["GESTIONES_TEAMS_USER_LOGEADO"].ToString() + "'";
                DataTable vDatos = vConexionGestiones.obtenerDataTableGestiones(vQuery);
        ...
        protected void BtnAddComentario_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (vEx != null)
                {
                    string usuario = Session["USUARIO_AD"].ToString() + ' ' + DateTime.Now.ToString("hh:mm:ss");
                ...
                else
                {
                    ...
                    if (vDatos != null)
                    {
                        if (vDatos.Rows.Count < 1)
                        {
                            vDatos.Rows.Add("1", Session["USUARIO_AD"].ToString() + ' ' + hora, TxComentario.Text);
                        }
                        else
                        {
                            vDatos.Rows.Add((vDatos.Rows.Count) + 1, Session["USUARIO_AD"].ToString() + ' ' + hora, TxComentario.Text);
                        }
                    }
        ...
        protected void BtnEnviar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string vEx = Request.QueryString["ex"];
                if (vEx != null && vReasignarTarea == null)
                {
                    validacionesCerrarTarea();

                    string FileName = FuSolucion.FileName;
                    if (FuSolucion.HasFile == true)
                    {
                        string FileNamez = FuSolucion.FileName;
                    }
                    ...
                    TxTimeModal.Text = TxMinProductivo.Text;
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (string.IsNullOrEmpty(vEx))
                    {
                        ...
                        string vCambio = "Creación de tarjeta, Estado: " + vidEstadoTexto + ", Prioridad: " + DdlPrioridad.SelectedItem;
                        ...
                        + "','" + Session["GESTIONES_CORREO_JEFE"].ToString() + "','" + vAsunto + "','" + "Datos Generales Tarjeta', '0','" + idSolicitud + "'";
                        Int32 vInfo5 = vConexionGestiones.ejecutarSqlGestiones(vQuery5);
                        ...
                        if (vInfo5 == 1)
                        {
                            ...
                            String vMensaje = "Tarea creada con éxito.";
                    ...
                    else
                    {
                        ...
                        {
                            vidEstado = "8";
                            vidEstadoTexto = "Reasignar Tarjeta";
                        }



                        string vCambio = "Finalizar Tarjeta, Estado: " + vidEstadoTexto + ", Detalle: " + TxDetalle.Text;
                        ...
                        if (vInfo2 == 1)
                        {
                            TxDetalle.Text = "";
                            DdlAccion.SelectedIndex = -1;
                            Response.Redirect("/sites/gestiones/pages/miTablero.aspx?ex=1");
                        }
                    }
        ...
        protected void GvReasignar_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Reasignar")
            {
                ...
                {
                    LbTituloTarjeta.InnerText = "Reasignar Tarjeta Kanban";
                    Response.Redirect("/sites/gestiones/pages/creacionTareas.aspx?ex=" + vIdTarjeta + "&exReasignar=1");
